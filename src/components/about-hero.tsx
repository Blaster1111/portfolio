...
import heroProfileImg from "@/public/images/pfp.png";
        ...
        <AnimatePresence>
          ...
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              I'm passionate about software engineering and turning vision into reality with code. Every project I work on reflects my commitment to building scalable, robust systems with clean architecture and meaningful user experiences. Beyond coding, I enjoy strategic thinking through chess, which helps me approach problems from different angles.
            </p>
          </FadeUp>
          ...
          <FadeUp key="coding-profiles" duration={0.6} delay={1.0}>
            <div className="mr-0 mt-8 flex flex-col items-center gap-4 lg:mr-8 lg:items-start">
