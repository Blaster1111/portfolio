      ...
      <Transition show={showModal} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center">
            ...
            >
              <Dialog.Panel className="absolute m-4 w-[95%] max-w-xl overflow-y-auto rounded-2xl border border-accent/30 bg-background px-6 py-8 shadow-xl shadow-accent/20 dark:border-accent/40 dark:bg-zinc-950 md:px-10 md:py-16">
                <div className="flex items-center justify-between">
                  <Dialog.Title className="flex items-center gap-1 text-2xl font-semibold text-zinc-900 dark:text-zinc-100 sm:gap-2 md:text-4xl">
                    <MailIcon className="h-8 w-8 text-accent sm:h-10 sm:w-10" />
                    <span>Send Message</span>
                  </Dialog.Title>
                  <button
                    className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-zinc-300 bg-zinc-100 p-2 text-sm text-accent transition-all hover:scale-[1.05] hover:bg-zinc-200 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"
